...
const middleware = (app) => {
    ...
    // by default, a form on a webpage can only send a GET or POST
    // method-override allows us to send PUT, PATCH, DELETE or other requests from a form by definit it with '_method'
